 ...
 * Solution description: Concordance code to test how often a word appears in a text file */
...
int main (int argc, const char * argv[]) {
	...
	for (int index = 0; index < hashTable->tableSize; index++){
		if(hashTable->table[index] != NULL) {
			struct hashLink *temp = (hashLink *) malloc(sizeof(hashLink));
